...
namespace SampleApp
{
    class MathematicsSampleApp
    {
        static void Main(string[] args)
        {
            ...
            var v4 = new Vector(new Point(3, 3.9999999999, 0));
            object objV3 = v3;
            ...
            Console.WriteLine($"v2 is objV3 ? {v2 == objV3}");
            Console.WriteLine($"v2 is almost equalt to v4 ? {v2.IsAlmosEqualTo(v4,0.1)}");
            Console.ReadLine();
        }
    }
}
